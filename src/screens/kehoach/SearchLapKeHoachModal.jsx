...
const SearchLapKeHoachModal = ({ visible, onClose, onSearch }) => {
     
    const [isLoading, setIsLoading] = useState(false);
    const [keyword, setKeyword] = useState("");
    const [nambt, setNamBT] = useState("");
                        ...
                        <View style={styles.loadingContainer}>
                         ...
                         <>
                            ...
                            <View style={styles.inputContainer}>                 
                                <Text>Năm bảo trì:</Text>
                                <View style={{marginTop:5}}>
                                    <SelectList setSelected={setNamBT} data={data} placeholder='Chọn năm'  />                           
                                </View>         
                            </View>
                            ...
                            <View style={styles.inputContainer}>
                                <Text>Từ khóa:</Text>
                                <TextInput
                                    placeholder="Tìm theo nơi bảo trì"
                                    value={keyword}
...
export default SearchLapKeHoachModal;
